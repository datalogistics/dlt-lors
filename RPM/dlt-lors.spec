...
BuildRequires:	cmake gcc libtool autoconf automake wget libuuid-devel zlib-devel curl-devel openssl-devel jansson-devel libunis-c popt-devel libxml2-devel
